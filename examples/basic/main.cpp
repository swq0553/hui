...
int main()
{
    ...
    if (!backgroundTexture.loadFromFile("examples/resources/literally.jpg"))
        return EXIT_FAILURE;
    sf::Sprite background(backgroundTexture);

    // Create some text to draw on top of our OpenGL object
    sf::Font font;
    if (!font.loadFromFile("examples/resources/SourceCodePro-Regular.ttf"))
        return EXIT_FAILURE;
    ...
    {
        sf::Image image;
        if (!image.loadFromFile("examples/resources/literally.jpg"))
            return EXIT_FAILURE;
